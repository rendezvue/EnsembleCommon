...
{	
	...
	TOOL_TYPE_CALC_DISTANCE		= TOOL_TYPE_DETECT_CIRCLE 	+ TOOL_TYPE_BASE_VALUE,
...
enum ImageExtOption
{
	IMAGE_ADD_TIME 			= 0x00010000,
	IMAGE_ADD_COUNT 		= 0x00020000,
	IMAGE_ADD_SOURCE_INFO 	= 0x00040000,
	IMAGE_THUMBNAIL 		= 0x80000000,
	IMAGE_ALL_AREA 			= 0x40000000,
	IMAGE_ICON				= 0x20000000,
};
